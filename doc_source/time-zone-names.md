...
The following list contains most of the valid time zone names that can be specified with the [CONVERT\_TIMEZONE function](CONVERT_TIMEZONE.md)\. For a current, complete of list time zone names, run the following command\.
