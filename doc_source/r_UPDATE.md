...
You can update a GENERATED BY DEFAULT AS IDENTITY column\. Columns defined as GENERATED BY DEFAULT AS IDENTITY can be updated with values you supply\. For more information, see [](r_CREATE_TABLE_NEW.md#identity-generated-bydefault-clause)\. 