...
The Vacuum Delete operation executed during Full vacuum or normal vacuum command does not work when some orphan transaction ids are still active in the cluster.
