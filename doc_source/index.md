...
+ [Sharing data across clusters](datashare-overview.md)
   + [Data sharing overview](data_sharing_intro.md)
   ...
   + [Working with views in data sharing](datashare-views.md)
   + [Managing the data sharing lifecycle](datashare-lifecycle.md)
   + [Controlling shared data access](control-access.md)
   + [Tracking usage and auditing in data sharing](auditing.md)
   + [Cluster management and data sharing](cluster-mgmt.md)
   + [Integrating data sharing with business intelligence tools](tool-integration.md)
   + [Accessing metadata for datashares](access-datashare.md)
