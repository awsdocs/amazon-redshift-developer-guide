...
+ [Sharing data across clusters in Amazon Redshift](datashare-overview.md)
   ...
   + [Working with AWS Data Exchange for Amazon Redshift (preview)](adx-datashare.md)
...
+ [Configuration reference](cm_chap_ConfigurationRef.md)
   ...
   + [datashare_break_glass_session_var (preview)](r_datashare_break_glass_session_var.md)
