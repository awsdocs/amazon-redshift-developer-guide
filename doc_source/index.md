...
+ [Ingesting and querying semistructured data in Amazon Redshift (preview)](super-overview.md)
   ...
   + [SUPER configurations](super-configration.md)
   ...
   + [Using SUPER data type with materialized views](r_SUPER_MV.md)
      + [Accelerating PartiQL queries](r_accelerate_mv.md)
         ...
         + [Creating Amazon Redshift scalar columns out of the shredded data](r_create_scalar.md)
      + [Limitations for using SUPER data type with materialized views](r_partiql_super_limitation.md)
+ [Querying data across databases (preview)](cross-database-overview.md)
...
+ [Sharing data across clusters (preview)](datashare-overview.md)
   ...
   + [Integrating business intelligence tools in data sharing](tool-integration.md)
   + [Accessing metadata for data shares](access-datashare.md)
   + [Considerations for data sharing](usage-notes-datashare.md)
...
+ [System tables reference](cm_chap_system-tables.md)
   ...
   + [System views](c_intro_system_views.md)
      ...
      + [SVL views](svl_views.md)
         ...
         + [SVL_DATASHARE_USAGE](r_SVL_DATASHARE_USAGE.md)
