...
+ [Working with automatic table optimization](t_Creating_tables.md)
   + [Working with column compression](t_Compressing_data_on_disk.md)
      + [Compression encodings](c_Compression_encodings.md)
         ...
         + [Run length encoding](c_Runlength_encoding.md)
...
+ [Creating materialized views in Amazon Redshift](materialized-view-overview.md)
   ...
   + [Streaming ingestion](materialized-view-streaming-ingestion.md)
      + [Getting started with streaming ingestion from Amazon Kinesis Data Streams](materialized-view-streaming-ingestion-getting-started.md)
      + [Getting started with streaming ingestion from Amazon Managed Streaming for Apache Kafka](materialized-view-streaming-ingestion-getting-started-MSK.md)
      + [Electric vehicle station-data streaming ingestion tutorial, using Kinesis](materialized-view-streaming-ingestion-example-station-data.md)
...
+ [Querying external data using Amazon Redshift Spectrum](c-using-spectrum.md)
   + [Getting started with Amazon Redshift Spectrum](c-getting-started-using-spectrum.md)
      ...
      + [Launch your AWS CloudFormation stack and then query your data in Amazon S3](c-getting-started-using-spectrum-query-s3-data-cfn.md)
...
+ [Querying data across databases](cross-database-overview.md)
...
+ [Sharing data across clusters in Amazon Redshift](datashare-overview.md)
   + [Regions where data sharing is available](data_sharing_regions.md)
   + [Overview of data sharing in Amazon Redshift](data_sharing_intro.md)
   ...
   + [Working with views in Amazon Redshift data sharing](datashare-views.md)
   + [Managing the data sharing lifecycle in Amazon Redshift](datashare-lifecycle.md)
   + [Managing permissions for datashares in Amazon Redshift](manage-permissions.md)
   + [Tracking usage and auditing in data sharing in Amazon Redshift](auditing.md)
   + [Cluster management and data sharing in Amazon Redshift](cluster-mgmt.md)
   + [Integrating Amazon Redshift data sharing with business intelligence tools](tool-integration.md)
   + [Accessing metadata for datashares in Amazon Redshift](access-datashare.md)
   + [Working with AWS Data Exchange for Amazon Redshift](adx-datashare.md)
   + [AWS Lake Formation-managed Redshift datashares (preview)](lake-formation-datashare.md)
   + [Getting started data sharing](getting-started-datashare.md)
      + [Getting started data sharing using the SQL interface](getting-started-datashare-sql.md)
         ...
         + [Sharing data across AWS Regions](across-region.md)
            + [Managing cost control for cross-Region data sharing](cross-region-billing.md)
         + [Sharing licensed Amazon Redshift data on AWS Data Exchange](adx-getting-started.md)
            + [Working with AWS Data Exchange datashares as a producer](adx-getting-started-producer.md)
            + [Working with AWS Data Exchange datashares as a consumer](adx-getting-started-consumer.md)
         + [Working with AWS Lake Formation-managed datashares](lake-formation-getting-started.md)
            + [Working with Lake Formation-managed datashares as a producer](lake-formation-getting-started-producer.md)
            + [Working with Lake Formation-managed datashares as a consumer](lake-formation-getting-started-consumer.md)
...
+ [Ingesting and querying semistructured data in Amazon Redshift](super-overview.md)
   + [SUPER sample dataset](r_SUPER_sample_dataset.md)
   + [Loading semistructured data into Amazon Redshift](ingest-super.md)
   + [Unloading semistructured data](unload-super.md)
   ...
   + [Querying semistructured data](query-super.md)
   + [Operators and functions](operators-functions.md)
   + [SUPER configurations](super-configurations.md)
   + [Limitations](limitations-super.md)
   + [Using SUPER data type with materialized views](r_SUPER_MV.md)
      + [Accelerating PartiQL queries](r_accelerate_mv.md)
         + [Shredding into SUPER columns with materialized views](r_shred_super.md)
         + [Creating Amazon Redshift scalar columns out of shredded data](r_create_scalar.md)
      + [Limitations for using the SUPER data type with materialized views](r_partiql_super_limitation.md)
+ [Using machine learning in Amazon Redshift](machine_learning.md)
...
+ [Implementing workload management](cm-c-implementing-workload-management.md)
   ...
   + [Working with concurrency scaling](concurrency-scaling.md)
      + [AWS Regions for concurrency scaling](concurrency-scaling-regions.md)
      + [Concurrency scaling candidates](concurrency-scaling-candidates.md)
      + [Configuring concurrency scaling queues](concurrency-scaling-queues.md)
      + [Monitoring concurrency scaling](concurrency-scaling-monitoring.md)
      + [Concurrency scaling system views](concurrency-scaling-monitoring-system-views.md)
...
+ [Managing database security](r_Database_objects.md)
   ...
   + [Role-based access control (RBAC)](t_Roles.md)
      ...
      + [Amazon Redshift system-defined roles](r_roles-default.md)
      + [System permissions for RBAC](r_roles-system-privileges.md)
      ...
      + [Considerations for role usage in RBAC](r_role-usage-notes.md)
      + [Managing roles in RBAC](r_roles-managing.md)
   + [Row-level security](t_rls.md)
      + [Using RLS policies in SQL statements](t_rls_statements.md)
      + [RLS policy ownership and management](t_rls_ownership.md)
      + [Policy-dependent objects and principles](t_rls_object_dependency.md)
      + [RLS policy usage notes](t_rls_usage.md)
      + [Best practices for RLS performance](t_rls_performance.md)
      + [RLS policy limitations](t_rls_limitations.md)
      + [Downgrading or restoring to an Amazon Redshift cluster version that doesn't support RLS](t_rls_downgrade.md)
      + [Creating, attaching, detaching, and dropping RLS policies](r_rls-procedures.md)
   + [Dynamic data masking (preview)](t_ddm.md)
      + [Managing dynamic data masking policies](r_ddm-procedures.md)
      + [Masking policy hierarchy](t_ddm-hierarchy.md)
      + [Conditional dynamic data masking](t_ddm-conditional.md)
      + [System views for dynamic data masking](r_ddm-svv.md)
+ [SQL reference](cm_chap_SQLCommandRef.md)
   ...
   + [SQL commands](c_SQL_commands.md)
      ...
      + [CREATE EXTERNAL TABLE](r_CREATE_EXTERNAL_TABLE.md)
         + [Usage notes](r_CREATE_EXTERNAL_TABLE_usage.md)
         + [Examples](r_CREATE_EXTERNAL_TABLE_examples.md)
      ...
      + [SELECT](r_SELECT_synopsis.md)
         ...
         + [GROUP BY clause](r_GROUP_BY_clause.md)
            + [Aggregation extensions](r_GROUP_BY_aggregation-extensions.md)
   ...
   + [SQL functions reference](c_SQL_functions.md)
      ...
      + [Aggregate functions](c_Aggregate_Functions.md)
         + [ANY_VALUE function](r_ANY_VALUE.md)
      ...
      + [Array functions](c_Array_Functions.md)
         ...
         + [array_concat function](r_array_concat.md)
         + [array_flatten function](array_flatten.md)
         + [get_array_length function](get_array_length.md)
         + [split_to_array function](split_to_array.md)
      ...
      + [VARBYTE functions and operators](varbyte-functions.md)
         ...
         + [FROM_HEX function](r_FROM_HEX.md)
         + [FROM_VARBYTE function](r_FROM_VARBYTE.md)
         + [GETBIT function](r_GETBIT.md)
         + [TO_HEX function](r_TO_HEX.md)
         + [TO_VARBYTE function](r_TO_VARBYTE.md)
      ...
      + [Data type formatting functions](r_Data_type_formatting.md)
         ...
         + [TO_DATE function](r_TO_DATE_function.md)
         + [TO_NUMBER](r_TO_NUMBER.md)
         + [TEXT_TO_INT_ALT](r_TEXT_TO_INT_ALT.md)
         + [TEXT_TO_NUMERIC_ALT](r_TEXT_TO_NUMERIC_ALT.md)
      ...
      + [Hash functions](hash-functions.md)
         ...
         + [MURMUR3_32_HASH](MURMUR3_32_HASH.md)
      + [HyperLogLog functions](hyperloglog-functions.md)
         ...
         + [HLL_COMBINE_SKETCHES function](r_HLL_COMBINE_SKETCHES.md)
      + [JSON functions](json-functions.md)
         ...
         + [JSON_PARSE function](JSON_PARSE.md)
         + [CAN_JSON_PARSE function](CAN_JSON_PARSE.md)
         + [JSON_SERIALIZE function](JSON_SERIALIZE.md)
         + [JSON_SERIALIZE_TO_VARBYTE function](JSON_SERIALIZE_TO_VARBYTE.md)
      + [Machine learning functions](ml-function.md)
         + [EXPLAIN_MODEL function](r_explain_model_function.md)
      ...
      + [Spatial functions](geospatial-functions.md)
         ...
         + [ST_Force2D](ST_Force2D-function.md)
         + [ST_Force3D](ST_Force3D-function.md)
         + [ST_Force3DM](ST_Force3DM-function.md)
         + [ST_Force3DZ](ST_Force3DZ-function.md)
         + [ST_Force4D](ST_Force4D-function.md)
         + [ST_GeoHash](ST_GeoHash-function.md)
         + [ST_GeogFromText](ST_GeogFromText-function.md)
         + [ST_GeogFromWKB](ST_GeogFromWKB-function.md)
         ...
         + [ST_GeomFromEWKT](ST_GeomFromEWKT-function.md)
         + [ST_GeomFromGeoJSON](ST_GeomFromGeoJSON-function.md)
         + [ST_GeomFromGeoHash](ST_GeomFromGeoHash-function.md)
         ...
         + [ST_Intersection](ST_Intersection-function.md)
         ...
         + [ST_MMax](ST_MMax-function.md)
         + [ST_MMin](ST_MMin-function.md)
         + [ST_Multi](ST_Multi-function.md)
         + [ST_NDims](ST_NDims-function.md)
         ...
         + [ST_Transform](ST_Transform-function.md)
         + [ST_Union](ST_Union-function.md)
         ...
         + [ST_Z](ST_Z-function.md)
         + [ST_ZMax](ST_ZMax-function.md)
         + [ST_ZMin](ST_ZMin-function.md)
      ...
      + [SUPER type information functions](c_Type_Info_Functions.md)
         + [DECIMAL_PRECISION function](r_decimal_precision.md)
         + [DECIMAL_SCALE function](r_decimal_scale.md)
         + [IS_ARRAY function](r_is_array.md)
         + [IS_BIGINT function](r_is_bigint.md)
         + [IS_BOOLEAN function](r_is_boolean.md)
         + [IS_CHAR function](r_is_char.md)
         + [IS_DECIMAL function](r_is_decimal.md)
         + [IS_FLOAT function](r_is_float.md)
         + [IS_INTEGER function](r_is_integer.md)
         + [IS_OBJECT function](r_is_object.md)
         + [IS_SCALAR function](r_is_scalar.md)
         + [IS_SMALLINT function](r_is_smallint.md)
         + [IS_VARCHAR function](r_is_varchar.md)
         + [JSON_SIZE function](r_json_size.md)
         + [JSON_TYPEOF function](r_json_typeof.md)
         + [SIZE](r_SIZE.md)
      ...
      + [System information functions](r_System_information_functions.md)
         + [CURRENT_AWS_ACCOUNT](r_CURRENT_AWS_ACCOUNT.md)
         + [CURRENT_DATABASE](r_CURRENT_DATABASE.md)
         + [CURRENT_NAMESPACE](r_CURRENT_NAMESPACE.md)
         ...
         + [DEFAULT_IAM_ROLE](r_DEFAULT_IAM_ROLE.md)
         + [HAS_ASSUMEROLE_PRIVILEGE](r_HAS_ASSUMEROLE_PRIVILEGE.md)
         ...
         + [PG_GET_GRANTEE_BY_IAM_ROLE](PG_GET_GRANTEE_BY_IAMROLE.md)
         + [PG_GET_IAM_ROLE_BY_USER](PG_GET_IAM_ROLE_BY_USER.md)
         ...
         + [USER](r_USER.md)
         + [ROLE_IS_MEMBER_OF](r_ROLE_IS_MEMBER_OF.md)
         + [USER_IS_MEMBER_OF](r_USER_IS_MEMBER_OF.md)
...
+ [System tables reference](cm_chap_system-tables.md)
   ...
   + [STV tables for snapshot data](c_intro_STV_tables.md)
      ...
      + [STV_DB_ISOLATION_LEVEL](r_STV_DB_ISOLATION_LEVEL.md)
      ...
      + [STV_ML_MODEL_INFO](r_STV_ML_MODEL_INFO.md)
      + [STV_MV_DEPS](r_STV_MV_DEPS.md)
      + [STV_MV_INFO](r_STV_MV_INFO.md)
      + [STV_NODE_STORAGE_CAPACITY](r_STV_NODE_STORAGE_CAPACITY.md)
   ...
   + [System views](c_intro_system_views.md)
      ...
      + [SVL views](svl_views.md)
         ...
         + [SVL_DATASHARE_CHANGE_LOG](r_SVL_DATASHARE_CHANGE_LOG.md)
         + [SVL_DATASHARE_CROSS_REGION_USAGE](r_SVL_DATASHARE_CROSS_REGION_USAGE.md)
         + [SVL_DATASHARE_USAGE_CONSUMER](r_SVL_DATASHARE_USAGE_CONSUMER.md)
         + [SVL_DATASHARE_USAGE_PRODUCER](r_SVL_DATASHARE_USAGE_PRODUCER.md)
         ...
         + [SVL_SPECTRUM_SCAN_ERROR](r_SVL_SPECTRUM_SCAN_ERROR.md)
      ...
      + [SVV views](svv_views.md)
         + [SVV_ALL_COLUMNS](r_SVV_ALL_COLUMNS.md)
         + [SVV_ALL_SCHEMAS](r_SVV_ALL_SCHEMAS.md)
         + [SVV_ALL_TABLES](r_SVV_ALL_TABLES.md)
         + [SVV_ALTER_TABLE_RECOMMENDATIONS](r_SVV_ALTER_TABLE_RECOMMENDATIONS.md)
         + [SVV_ATTACHED_MASKING_POLICY](r_SVV_ATTACHED_MASKING_POLICY.md)
         + [SVV_COLUMNS](r_SVV_COLUMNS.md)
         + [SVV_COLUMN_PRIVILEGES](r_SVV_COLUMN_PRIVILEGES.md)
         + [SVV_DATABASE_PRIVILEGES](r_SVV_DATABASE_PRIVILEGES.md)
         + [SVV_DATASHARE_PRIVILEGES](r_SVV_DATASHARE_PRIVILEGES.md)
         + [SVV_DATASHARES](r_SVV_DATASHARES.md)
         + [SVV_DATASHARE_CONSUMERS](r_SVV_DATASHARE_CONSUMERS.md)
         + [SVV_DATASHARE_OBJECTS](r_SVV_DATASHARE_OBJECTS.md)
         + [SVV_DEFAULT_PRIVILEGES](r_SVV_DEFAULT_PRIVILEGES.md)
         ...
         + [SVV_FUNCTION_PRIVILEGES](r_SVV_FUNCTION_PRIVILEGES.md)
         + [SVV_IAM_PRIVILEGES](r_SVV_IAM_PRIVILEGES.md)
         + [SVV_INTERLEAVED_COLUMNS](r_SVV_INTERLEAVED_COLUMNS.md)
         + [SVV_IDENTITY_PROVIDERS](r_SVV_IDENTITY_PROVIDERS.md)
         + [SVV_LANGUAGE_PRIVILEGES](r_SVV_LANUGAGE_PRIVILEGES.md)
         + [SVV_MASKING_POLICY](r_SVV_MASKING_POLICY.md)
         + [SVV_ML_MODEL_INFO](r_SVV_ML_MODEL_INFO.md)
         + [SVV_ML_MODEL_PRIVILEGES](r_SVV_ML_MODEL_PRIVILEGES.md)
         + [SVV_MV_DEPENDENCY](r_SVV_MV_DEPENDENCY.md)
         + [SVV_MV_INFO](r_SVV_MV_INFO.md)
         + [SVV_QUERY_INFLIGHT](r_SVV_QUERY_INFLIGHT.md)
         + [SVV_QUERY_STATE](r_SVV_QUERY_STATE.md)
         + [SVV_REDSHIFT_COLUMNS](r_SVV_REDSHIFT_COLUMNS.md)
         + [SVV_REDSHIFT_DATABASES](r_SVV_REDSHIFT_DATABASES.md)
         + [SVV_REDSHIFT_FUNCTIONS](r_SVV_REDSHIFT_FUNCTIONS.md)
         + [SVV_REDSHIFT_SCHEMAS](r_SVV_REDSHIFT_SCHEMAS.md)
         + [SVV_REDSHIFT_TABLES](r_SVV_REDSHIFT_TABLES.md)
         + [SVV_RELATION_PRIVILEGES](r_SVV_RELATION_PRIVILEGES.md)
         + [SVV_RLS_APPLIED_POLICY](r_SVV_RLS_APPLIED_POLICY.md)
         + [SVV_RLS_ATTACHED_POLICY](r_SVV_RLS_ATTACHED_POLICY.md)
         + [SVV_RLS_POLICY](r_SVV_RLS_POLICY.md)
         + [SVV_RLS_RELATION](r_SVV_RLS_RELATION.md)
         + [SVV_ROLES](r_SVV_ROLES.md)
         + [SVV_ROLE_GRANTS](r_SVV_ROLE_GRANTS.md)
         + [SVV_SCHEMA_QUOTA_STATE](r_SVV_SCHEMA_QUOTA_STATE.md)
         + [SVV_SCHEMA_PRIVILEGES](r_SVV_SCHEMA_PRIVILEGES.md)
         + [SVV_SYSTEM_PRIVILEGES](r_SVV_SYSTEM_PRIVILEGES.md)
         + [SVV_TABLES](r_SVV_TABLES.md)
         + [SVV_TABLE_INFO](r_SVV_TABLE_INFO.md)
         + [SVV_TRANSACTIONS](r_SVV_TRANSACTIONS.md)
         + [SVV_USER_INFO](r_SVV_USER_INFO.md)
         + [SVV_USER_GRANTS](r_SVV_USER_GRANTS.md)
      ...
      + [Monitoring views](serverless_views-monitoring.md)
         + [SYS_CONNECTION_LOG](SYS_CONNECTION_LOG.md)
         + [SYS_COPY_JOB (preview)](SYS_COPY_JOB.md)
         + [SYS_DATASHARE_CHANGE_LOG](SYS_DATASHARE_CHANGE_LOG.md)
         + [SYS_DATASHARE_USAGE_CONSUMER](SYS_DATASHARE_USAGE_CONSUMER.md)
         + [SYS_DATASHARE_USAGE_PRODUCER](SYS_DATASHARE_USAGE_PRODUCER.md)
         + [SYS_EXTERNAL_QUERY_DETAIL](SYS_EXTERNAL_QUERY_DETAIL.md)
         + [SYS_LOAD_DETAIL](SYS_LOAD_DETAIL.md)
         + [SYS_LOAD_ERROR_DETAIL](SYS_LOAD_ERROR_DETAIL.md)
         + [SYS_LOAD_HISTORY](SYS_LOAD_HISTORY.md)
         + [SYS_QUERY_DETAIL](SYS_QUERY_DETAIL.md)
         + [SYS_QUERY_HISTORY](SYS_QUERY_HISTORY.md)
         + [SYS_SERVERLESS_USAGE](SYS_SERVERLESS_USAGE.md)
         + [SYS_STREAM_SCAN_ERRORS](r_SYS_STREAM_SCAN_ERRORS.md)
         + [SYS_STREAM_SCAN_STATES](r_SYS_STREAM_SCAN_STATES.md)
         + [SYS_UNLOAD_HISTORY](SYS_UNLOAD_HISTORY.md)
...
+ [Configuration reference](cm_chap_ConfigurationRef.md)
   ...
   + [cast_super_null_on_error](r_cast_super_null_on_error.md)
   + [datashare_break_glass_session_var](r_datashare_break_glass_session_var.md)
   + [datestyle](r_datestyle.md)
   + [default_geometry_encoding](r_default_geometry_encoding.md)
   + [describe_field_name_in_uppercase](r_describe_field_name_in_uppercase.md)
   + [downcase_delimited_identifier](r_downcase_delimited_identifier.md)
   + [enable_case_sensitive_identifier](r_enable_case_sensitive_identifier.md)
   + [enable_case_sensitive_super_attribute](r_enable_case_sensitive_super_attribute.md)
   ...
   + [mv_enable_aqmv_for_session](r_mv_enable_aqmv_for_session.md)
   + [navigate_super_null_on_error](r_navigate_super_null_on_error.md)
   + [parse_super_null_on_error](r_parse_super_null_on_error.md)
   + [pg_federation_repeatable_read](r_pg_federation_repeatable_read.md)
   + [query_group](r_query_group.md)
   + [search_path](r_search_path.md)
   + [spectrum_enable_pseudo_columns](r_spectrum_enable_pseudo_columns.md)
   + [enable_spectrum_oid](r_spectrum_enable_spectrum_oid.md)
   + [spectrum_query_maxerror](r_spectrum_query_maxerror.md)
